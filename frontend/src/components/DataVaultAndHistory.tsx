...
export const DataVaultAndHistory: React.FC<DataVaultProps> = ({ projectStatus }) => {
  ...
  const vaultItems = [
    {
      id: 'art-001',
      name: 'Scene_01_Dialogue_Draft_v3.fountain',
      ...
      status: 'Locked',
      preview: 'EXT. TITANIC DECK - NIGHT\nThe icy wind whips across the iron hull as Captain Smith checks the barometer...',
    },
    {
      id: 'art-002',
      name: 'Camera_Track_Shot_01A_CineCam.json',
      ...
      status: 'Calibrated',
      preview: 'Focal Length: 35mm Prime | Sensor: Full Frame 36x24mm | Dolly Speed: 1.8 m/s | Orbit Vector: [12.4, -4.2, 8.9]',
    },
    {
      id: 'art-003',
      name: 'ControlNet_Depth_Pass_Scene01.png',
      ...
      status: 'Rendered',
      preview: 'Model: FLUX.1 Dev | ControlNet: Depth V2 (Weight 0.85) | Guidance: 3.5 | Resolution: 1920x1080',
    },
    {
      id: 'art-004',
      name: 'Dialogue_Stem_CaptSmith_Line12.wav',
      ...
      status: 'Mixed',
      preview: 'Voice Model: ElevenLabs Baritone British | Spatialization: 5.1 Surround Submix | Noise Floor: -64 dB',
    },
    {
      id: 'art-005',
      name: 'Arise_Timeline_Master_Reel_01.edl',
      ...
      status: 'Conformed',
      preview: '001  AX       V     C        00:00:00:00 00:00:08:12 00:00:00:00 00:00:08:12\n* FROM CLIP NAME: SCENE01_SHOT01_TAKE03',
    },
    {
      id: 'art-006',
      name: 'Final_Color_LUT_FilmEmulation_2383.cube',
      ...
      author: 'Colorist AI',
      status: 'Graded',
      preview: 'Target: Rec.709 Gamma 2.4 | Highlights: Warm Tungsten Roll-off | Shadows: Cyan Split-Tone',
    },
    {
      id: 'art-007',
      name: 'Vertical_9x16_Reel_Cut_Ep1.mp4',
      ...
      status: 'Ready',
      preview: 'Format: 9:16 Vertical (1080x1920) | Safe Zone: Center 80% | Auto-Captions: Synchronized',
    },
  ];
