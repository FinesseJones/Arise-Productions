                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, studioName: e.target.value }))}
                      disabled={!isEditing}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, tagline: e.target.value }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setStudioConfig(prev => ({ ...prev, description: e.target.value }))}
                      disabled={!isEditing}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, copyrightText: e.target.value }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, maxProjects: parseInt(e.target.value) }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, aiAgentsCount: parseInt(e.target.value) }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <Input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, primaryColor: e.target.value }))}
                        disabled={!isEditing}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <Input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, secondaryColor: e.target.value }))}
                        disabled={!isEditing}
                        className="w-16 h-10 bg-navy-800/50 border-gold-500/30"
                      />
                      <Input
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <Input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, accentColor: e.target.value }))}
                        disabled={!isEditing}
                        className="w-16 h-10 bg-navy-800/50 border-gold-500/30"
                      />
                      <Input
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, heroTitle: e.target.value }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStudioConfig(prev => ({ ...prev, heroSubtitle: e.target.value }))}
                      disabled={!isEditing}
                      className="bg-navy-800/50 border-gold-500/30 text-white placeholder:text-gray-500 focus:border-gold-400"
                    />
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked: boolean) => setStudioConfig(prev => ({ ...prev, enableAIStudio: checked }))}
                          disabled={!isEditing}
                          className="data-[state=checked]:bg-gold-500"
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked: boolean) => setStudioConfig(prev => ({ ...prev, enableEditingSuite: checked }))}
                          disabled={!isEditing}
                          className="data-[state=checked]:bg-gold-500"
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked: boolean) => setStudioConfig(prev => ({ ...prev, enablePlatformOptimizer: checked }))}
                          disabled={!isEditing}
                          className="data-[state=checked]:bg-gold-500"
                        />
                      </div>
